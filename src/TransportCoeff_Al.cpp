...
double alpha_para(double chi, int Z){
    ...
    double alpha0 = 0.324;//alphavalues[Z-1][0];
...
double alpha_perp(double chi, int Z){
    ...
    double alpha0p = 1.89;//alphavalues[Z-1][1];
    double alpha1p = 3.10;//alphavalues[Z-1][2];
    double a0p = 2.80;//alphavalues[Z-1][3];
    double a1p = 6.20;//alphavalues[Z-1][4];
...
double alpha_wedg(double chi, int Z){
    ...
    double alpha0pp = 975;//alphavalues[Z-1][5];
    double alpha1pp = 2.53;//alphavalues[Z-1][6];
    double a0pp = 3370;//alphavalues[Z-1][7];
    double a1pp = 14900;//alphavalues[Z-1][8];
    double a2pp = 930;//alphavalues[Z-1][9];
...
double beta_para(double chi, int Z){
    ...
    double beta0 = 1.32;//betavalues[Z-1][0];
...
double beta_perp(double chi, int Z){
    ...
    double beta0p = 1900;//betavalues[Z-1][1];
    double beta1p = 6.33;//betavalues[Z-1][2];
    double b0p = 3580;//betavalues[Z-1][3];
    double b1p = 13100;//betavalues[Z-1][4];
    double b2p = 763;//betavalues[Z-1][5];
...
double beta_wedg(double chi, int Z){
    ...
    double beta0pp = 2.57;//betavalues[Z-1][6];
    double beta1pp = 1.5;//betavalues[Z-1][7];
    double b0pp = 0.415;//betavalues[Z-1][8];
    double b1pp = 2.97;//betavalues[Z-1][9];
    double b2pp = 7.25;//betavalues[Z-1][10];
...
double kappa_para(double chi, int Z){
    ...
    double gamma0 = 10.3;//kappavalues[Z-1][0];
...
double kappa_perp(double chi, int Z){
    ...
    double gamma0p = 7.2;//kappavalues[Z-1][1];
    double gamma1p = 3.36;//kappavalues[Z-1][2];
    double c0p = 0.7;//kappavalues[Z-1][3];
    double c1p = 4.68;//kappavalues[Z-1][4];
    double c2p = 8.7;//kappavalues[Z-1][5];
...
double kappa_wedg(double chi, int Z){
    ...
    double gamma0pp = 0.26;//kappavalues[Z-1][6];
    double gamma1pp = 2.5;//kappavalues[Z-1][7];
    double c0pp = 0.00235;//kappavalues[Z-1][8];
    double c1pp = 0.0303;//kappavalues[Z-1][9];
    double c2pp = 0.476;//kappavalues[Z-1][10];
